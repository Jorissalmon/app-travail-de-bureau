...
lines.push('--')
lines.push('-- The statement splitter (scripts/sql-split.ts) skips -- comments, so an')
lines.push('-- apostrophe or a semicolon in one is safe. It was not always: a semicolon')
lines.push('-- in the comment below used to cut this file mid-sentence.')
lines.push('')
lines.push('BEGIN;')
lines.push('')
